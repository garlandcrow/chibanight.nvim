local ts = require("chibanight.treesitter")
...
function M.invert_color(color)
  local hsluv = require("chibanight.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("chibanight.util").onColorScheme()]])
